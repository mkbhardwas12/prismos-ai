...
describe("CORE_AGENTS", () => {
  ...
  it("defines exactly 5 available core roles", () => {
  ...
  it("includes all required agents", () => {
    ...
    expect(ids).not.toContain("email_keeper");
    expect(ids).not.toContain("calendar_keeper");
    expect(ids).not.toContain("finance_keeper");
  });
