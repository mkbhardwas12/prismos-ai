...
mod tests {
    ...
    // Query-Type × Cognitive-Profile Matrix — Comprehensive Claim Coverage
    //
    // These tests validate every element of the patent claim:
    //   (a) classifying a natural language query into a query type
    //   (b) determining a natural reasoning band for said query type
    //   (c) computing a preference strength from a persistent multi-dimensional
    //       cognitive profile
    //   (d) selecting the natural band when override_strength > preference_strength,
    //       otherwise selecting the user's preferred band
    //   (e) new users receive query-appropriate defaults
    //   (f) experienced users retain calibrated preferences except for
    //       high-confidence query types
    // ═══════════════════════════════════════════════════════════════════════════

    // ── Claim Element (a): Query Classification Exhaustiveness ───────────────
    ...
    // ── Claim Element (b): Natural Band Mapping ─────────────────────────────
    ...
    // ── Claim Element (b): Override Strength Values ─────────────────────────
    ...
    // ── Claim Element (c): Preference Strength Computation ──────────────────
    ...
    // ── Claim Element (d): Override Logic — the Core Patent Mechanism ───────
    ...
    // ── Claim Element (e): New Users Get Smart Defaults ─────────────────────
    ...
    // ── Claim Element (f): Experienced Users ────────────────────────────────
    ...
    fn test_emergent_behavior_creative_user_debugging_gets_direct() {
        // The patent's key example: creative user debugging → Direct
