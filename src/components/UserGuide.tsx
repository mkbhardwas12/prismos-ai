          ...
          <div className="guide-content">
            ...
            {activeSection === "about" && (
              <div className="guide-section">
                ...
                <div className="guide-card highlight">
                  <h4>📋 Patent Notice</h4>
                  <p><strong>Patent Pending</strong> — US Provisional Patent Application No. <strong>63/993,589</strong>, filed <strong>February 28, 2026</strong>.</p>
                  ...
                  <ul>
                    ...
                    <li><strong>Refractive Core™</strong> — Intent refraction through spectral analysis</li>
                    <li><strong>You-Port™</strong> — Encrypted personality migration with graph merge/diff</li>
                  </ul>
                  <p style={{ marginTop: "10px", fontSize: "12px", opacity: 0.8 }}>Inventor: Manish Kumar</p>
                </div>

                <div className="guide-card">
                  <h4>📄 License</h4>
                  <p>PrismOS is released under the <strong>MIT License</strong> for personal and educational use.</p>
                  <p>Commercial use of the patented inventions (Spectrum Graph, Refractive Core, You-Port) requires a separate license from the inventor.</p>
                </div>
